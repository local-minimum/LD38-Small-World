...
namespace Rant.Core
{
	internal sealed partial class Sandbox
	{
		...
		public QueryBuilder QueryBuilder { get{ return qb; } } 
		...
		/// </summary>
		public OutputWriter Output { get { return _outputs.Peek (); } }
		/// <summary>
		...
		/// The block manager.
		/// </summary>
		public BlockAttribManager AttribManager { get { return _blockManager;
		}}
	}
}
